...
export default function Home() {
  ...
  const loadChatHistory = () => {
    // Manually manage or fetch stored messages
    const storedMessages = memory.memory[memory.memoryKey] || []; // This assumes you have access to the memory property
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      memory.memory[memory.memoryKey] = [...messages, { role: 'user', content: message }]; // This assumes you have access to the memory property
