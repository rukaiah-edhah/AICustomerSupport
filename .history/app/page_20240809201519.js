...
import { AppBar, Toolbar, Typography, Box, Button, Stack, TextField, IconButton, RadioGroup, FormControlLabel, Radio } from '@mui/material'
...
export default function Home() {
  ...
  const [chatHistories, setChatHistories] = useState([]) // Add state for chat histories
  const [selectedChatId, setSelectedChatId] = useState(null) // Add state for selected chat history
