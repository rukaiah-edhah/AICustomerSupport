...
import { BufferMemory } from 'some-memory-package';  // Adjust this import based on the actual package
...
export default function Home() {
  ...
  const loadChatHistory = () => {
    const storedMessages = memory.retrieve("chat_history"); // Retrieve messages from BufferMemory
    if (storedMessages) {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      memory.store("chat_history", messages); // Store updated messages in BufferMemory
